...
router.post('/trips', (req, res, next) => isAuthorized(req, res, next).catch(next), async (req, res) => {
    const trip = new Trip(null,req.body.country,req.body.countryId,req.body.city,req.body.arrivalDate,req.body.departureDate,req.body.status,req.body.userId);
...
router.patch('/trips/:id', (req, res, next) => isAuthorized(req, res, next).catch(next),  async (req, res) => {
    const trip = new Trip(req.body.tripId,req.body.country,req.body.countryId,req.body.city,req.body.arrivalDate,req.body.departureDate,req.body.status,req.body.userId, req.body.userFirstname,req.body.userLastname,req.body.userPromo);
